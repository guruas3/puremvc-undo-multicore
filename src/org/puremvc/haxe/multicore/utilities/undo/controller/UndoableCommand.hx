 ...
 */
class UndoableCommand extends SimpleCommand implements IUndoableCommand {
	 ...
	 * [UndoableCommandType.NON_RECORDABLE_COMMAND] so that it won't get recorded into the history
	 ...
	 * and its notification type is set to [UndoableCommand.NON_RECORDABLE_COMMAND]</p>
	 **/
	public function undo():Void {
		...
		_note.setType(UndoableCommandType.NON_RECORDABLE_COMMAND);
